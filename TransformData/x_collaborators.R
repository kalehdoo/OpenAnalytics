...
collaborators<-subset.data.frame(sponsors, subset=lead_or_collaborator=="collaborator", select = c("nct_id",
                                                                                           "agency_class",
                                                                                           "name",
                                                                                           "id")
)
...
#rename columns
colnames(collaborators)[colnames(collaborators)=="name"]<-"collaborator_name"
colnames(collaborators)[colnames(collaborators)=="id"]<-"collaborator_id"

#write to txt file
write.table(collaborators, paste(var_DIR_HOME, "Data/ACCT/DATA/warehouse/x_collaborators.txt", sep=""), sep = "|", row.names = FALSE)
