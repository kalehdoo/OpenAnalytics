...
agg_sponsors<-agg_studies %>%
  ...
  summarise(cnt_studies_registered=n(),##counts number of records
            ...
            cnt_interventional=sum(if_else(study_type=="Interventional",1,0)),
            cnt_observational=sum(if_else(study_type=="Observational",1,0)),
            cnt_phase3=sum(if_else(phase=="Phase 3",1,0)),
            cnt_phase4=sum(if_else(phase=="Phase 4",1,0)),
            cnt_actual_study_enrollment=sum(actual_study_enrollment),
            cnt_anticipated_study_enrollment=sum(anticipated_study_enrollment),
            
            cnt_study_submitted_lstyr=sum(if_else(study_first_posted_year==var_last_year[1],flag_study_submitted,0)),
            cnt_started_actual_lstyr=sum(if_else(start_year==var_last_year[1],flag_actual_started,0)),
            cnt_completed_status_lstyr=sum(if_else(completed_year==var_last_year[1],flag_completed_status,0)),
            cnt_results_submitted_lstyr=sum(if_else(results_submit_year==var_last_year[1],flag_results_posted,0)),
            ratio_results_to_completed_lstyr=100*(sum(cnt_results_submitted_lstyr)/sum(cnt_completed_status_lstyr)),
            
            cnt_study_submitted_lstyr2=sum(if_else(study_first_posted_year==var_last_year_2[1],flag_study_submitted,0)),
            cnt_started_actual_lstyr2=sum(if_else(start_year==var_last_year_2[1],flag_actual_started,0)),
            cnt_completed_status_lstyr2=sum(if_else(completed_year==var_last_year_2[1],flag_completed_status,0)),
            cnt_results_submitted_lstyr2=sum(if_else(results_submit_year==var_last_year_2[1],flag_results_posted,0)),
            ratio_results_to_completed_lstyr2=100*(sum(cnt_results_submitted_lstyr2)/sum(cnt_completed_status_lstyr2)),
            
            cnt_study_submitted_lstyr3=sum(if_else(study_first_posted_year==var_last_year_3[1],flag_study_submitted,0)),
            cnt_started_actual_lstyr3=sum(if_else(start_year==var_last_year_3[1],flag_actual_started,0)),
            cnt_completed_status_lstyr3=sum(if_else(completed_year==var_last_year_3[1],flag_completed_status,0)),
            cnt_results_submitted_lstyr3=sum(if_else(results_submit_year==var_last_year_3[1],flag_results_posted,0)),
            ratio_results_to_completed_lstyr3=100*(sum(cnt_results_submitted_lstyr3)/sum(cnt_completed_status_lstyr3)),
            
            cnt_study_submitted_lstyr4=sum(if_else(study_first_posted_year==var_last_year_4[1],flag_study_submitted,0)),
            ...
            cnt_results_submitted_lstyr4=sum(if_else(results_submit_year==var_last_year_4[1],flag_results_posted,0)),
            ratio_results_to_completed_lstyr4=100*(sum(cnt_results_submitted_lstyr4)/sum(cnt_completed_status_lstyr4)),
            
            cnt_study_submitted_lstyr5=sum(if_else(study_first_posted_year==var_last_year_5[1],flag_study_submitted,0)),
            cnt_started_actual_lstyr5=sum(if_else(start_year==var_last_year_5[1],flag_actual_started,0)),
            cnt_completed_status_lstyr5=sum(if_else(completed_year==var_last_year_5[1],flag_completed_status,0)),
            cnt_results_submitted_lstyr5=sum(if_else(results_submit_year==var_last_year_5[1],flag_results_posted,0)),
